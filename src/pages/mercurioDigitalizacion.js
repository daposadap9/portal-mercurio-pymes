      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row justify-around gap-4">
        ...
        <div className="w-full md:w-[35%]">
          <div className="text-center md:text-left">
            ...
            CON SERVISOFT S.A DILE ADIS AL PAPEL DESORDENADO Y AL RIESGO DE PÉRDIDA. CON NUESTRA DIGITALIZACIÓN DOCUMENTAL, TODA TÚ INFORMACIÓN ESTARÁ ORGANIZADA Y PROTEGIDA.
            </p>
            <p className="mb-4 leading-relaxed text-gray-700">
            ...
            <p className="mb-4 leading-relaxed text-gray-700">
            TE APOYAMOS CON EL CUMPLIMIENTO DE NORMATIVAS LEGALES Y PROTEGEMOS TÚ INFORMACIÓN CON COPIAS DIGITALES SEGURAS Y RESPALDADAS.
            </p>
          </div>
        </div>
